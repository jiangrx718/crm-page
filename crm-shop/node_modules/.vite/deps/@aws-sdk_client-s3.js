...
function addExpectContinueMiddleware(options) {
  return (next) => async (args) => {
    var _a, _b, _c2, _d2;
    const { request } = args;
    if (options.expectContinueHeader !== false && HttpRequest.isInstance(request) && request.body && options.runtime === "node" && ((_b = (_a = options.requestHandler) == null ? void 0 : _a.constructor) == null ? void 0 : _b.name) !== "FetchHttpHandler") {
      let sendHeader = true;
...
var HttpProtocol = class extends SerdeContext {
  ...
  async loadEventStreamCapability() {
    const { EventStreamSerde } = await import("./event-streams-WXLWNGWL.js");
  ...
  findQueryCompatibleError(registry, errorName) {
    try {
      ...
      return registry.find((schema) => {
        var _a;
        return ((_a = NormalizedSchema.of(schema).getMergedTraits().awsQueryError) == null ? void 0 : _a[0]) === errorName;
      });
    }
  }
};
...
var loadRestXmlErrorCode = (output, data2) => {
  var _a;
  if (((_a = data2 == null ? void 0 : data2.Error) == null ? void 0 : _a.Code) !== void 0) {
...
var XmlShapeSerializer = class extends SerdeContextConfig {
  ...
  write(schema, value) {
    ...
    if (ns.isStringSchema() && typeof value === "string") {
      ...
      this.byteBuffer = "byteLength" in value ? value : (((_a = this.serdeContext) == null ? void 0 : _a.base64Decoder) ?? fromBase64)(value);
    } else {
  ...
  flush() {
    ...
    if (this.settings.xmlNamespace) {
      if (!((_a = buffer == null ? void 0 : buffer.attributes) == null ? void 0 : _a["xmlns"])) {
  ...
  writeSimple(_schema, value) {
    ...
    if (value && typeof value === "object") {
      if (ns.isBlobSchema()) {
        nodeContents = (((_a = this.serdeContext) == null ? void 0 : _a.base64Encoder) ?? toBase64)(value);
...
var AwsRestXmlProtocol = class extends HttpBindingProtocol {
  ...
  async handleError(operationSchema, context, response, dataObject, metadata) {
    ...
    const message = ((_a = dataObject.Error) == null ? void 0 : _a.message) ?? ((_b = dataObject.Error) == null ? void 0 : _b.Message) ?? dataObject.message ?? dataObject.Message ?? "Unknown";
  ...
  return (next, context) => async (args) => {
    ...
    try {
      ...
      if (clientConfig.followRegionRedirects) {
        const statusCode = (_a = err == null ? void 0 : err.$metadata) == null ? void 0 : _a.httpStatusCode;
        const isHeadBucket = context.commandName === "HeadBucketCommand";
        const bucketRegionHeader = (_c2 = (_b = err == null ? void 0 : err.$response) == null ? void 0 : _b.headers) == null ? void 0 : _c2["x-amz-bucket-region"];
...
var s3ExpressMiddleware = (options) => {
  return (next, context) => async (args) => {
    ...
    if (context.endpointV2) {
      ...
      const isS3ExpressAuth = ((_c2 = (_b = (_a = endpoint.properties) == null ? void 0 : _a.authSchemes) == null ? void 0 : _b[0]) == null ? void 0 : _c2.name) === S3_EXPRESS_AUTH_SCHEME;
...
var createEndpointRuleSetHttpAuthSchemeParametersProvider = (defaultHttpAuthSchemeParametersProvider) => async (config, context, input) => {
  ...
  const instructionsFn = (_c2 = (_b = (_a = getSmithyContext(context)) == null ? void 0 : _a.commandInstance) == null ? void 0 : _b.constructor) == null ? void 0 : _c2.getEndpointParameterInstructions;
  if (!instructionsFn) {
...
var getRuntimeConfig = (config) => {
  return {
    ...
    protocol: (config == null ? void 0 : config.protocol) ?? AwsRestXmlProtocol,
...
var createMessageFromResponse = (reason) => {
  ...
  return String((reason == null ? void 0 : reason.message) ?? JSON.stringify(reason, getCircularReplacer()) ?? "Unknown");
};
