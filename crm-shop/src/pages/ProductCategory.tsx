...
const ProductCategory: React.FC = () => {
  ...
  const fetchCategories = async () => {
    try {
      const res = await axios.get(`${API_BASE_URL}/api/category/product/list?category_type=2`);
      ...
      <Switch
        ...
        onChange={async (checked) => {
          try {
            ...
            const res = await axios.post(`${API_BASE_URL}/api/category/product/status`, { 
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          ...
          {hasChildren ? (
            ...
            <Popconfirm
              ...
              onConfirm={async () => {
                try {
                  const res = await axios.post(`${API_BASE_URL}/api/category/product/delete`, { category_id: record.id });
                  if (res.data.code === 0) {
  ...
  const onEditOk = async () => {
    try {
      ...
      await axios.post(`${API_BASE_URL}/api/category/product/update`, payload);
  ...
  const onAddOk = async () => {
    try {
      ...
      await axios.post(`${API_BASE_URL}/api/category/product/create`, payload);
